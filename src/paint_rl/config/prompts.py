...
4. For watercolor fill effects: use brush.fill(color, opacity) and brush.bleed(strength, 'out'). 'watercolor' is NOT a brush name.
...
8. Output ONLY executable p5.js code inside a ```javascript block. Keep sketches concise and complete within 350 tokens.
"""
