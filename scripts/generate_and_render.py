...
def main():
    ...
    system_prompt = (
        ...
        "    // Stroke brushes: 'HB', '2B', '2H', 'cpencil', 'pen', 'rotring',\n"
        "    //                  'spray', 'marker', 'marker2', 'charcoal'\n"
        "    brush.set('charcoal', '#3a6073', 2);\n"
        "    brush.line(50, 300, 550, 300);\n"
        "    // Watercolor fill (NOT a stroke brush name!):\n"
        ...
        "4. For watercolor effects: brush.fill(color, opacity) + brush.fillBleed(). 'watercolor' is NOT a brush name.\n"
